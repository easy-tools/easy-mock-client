...
class EasyMockClient {//  extends EasyMockClientAbstract
  ...
  updateMock(mockData) {
    ...
    const handler = () => {
      return this.generatePost('/api/mock/update', Object.assign({
      }, mockData))
    }
  ...
  createMock(mockData) {
    ...
    const handler = () => {
      return this.generatePost('/api/mock/create', Object.assign({
      }, mockData))
    }
  ...
  createProject(projectData) {
    ...
    const handler = () => {
      return this.generatePost('/api/project/create', Object.assign({
      }, projectData))
    }
