...
class CommandInvoker {
  ...
  __parseCommand(argvParams) {
    ...
    } else if (argvParams[0] === 'project' && argvParams[1] === 'update') {
      command.register(argvParams, projectModule.updateProject)
    } else {
  ...
  help() {
    ...
    const commands = [{
      ...
      name: 'mock update',
      options: [],
      description: 'update mock api',
      example: '$ easy-mock-client mock update',
    }, {
      name: 'project create',
      options: [],
      ...
      example: '$ easy-mock-client project update',
    }]
    const maxLength = []
    const contentList = []
